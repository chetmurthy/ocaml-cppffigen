...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8533bdbff2079ade42b13b09568f7b17) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Misc"; "Cppffigen"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "cppffigen";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cppffigen.ml"});
               Executable
                 ({
                     cs_name = "cppffigen_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "cppffigen"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                      bs_interface_patterns =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "cppffigen_example.ml"
                   })
            ];
     ...
     oasis_digest = Some "\211\025:|\252\162\b;\228)\143\n+X\209\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
